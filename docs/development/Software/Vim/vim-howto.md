- [init/config vim](#initconfig-vim)
    - [vim plugin: `Vundle`](#vim-plugin-vundle)
    - [color scheme: `monokai`](#color-scheme-monokai)
    - [vim plugin: `file-line`: go/jump to line after name](#vim-plugin-file-line-gojump-to-line-after-name)
    - [autocomplete support: `YouCompleteMe`](#autocomplete-support-youcompleteme)
        - [bugfix: `No .ycm_extra_conf.py file detected. #415`](#bugfix-no-ycm_extra_confpy-file-detected-415)
    - [Add custom input](#add-custom-input)
        - [Add date input](#add-date-input)
        - [Add arpara signature input](#add-arpara-signature-input)
    - [Add edit control](#add-edit-control)
    - [Add display control](#add-display-control)
- [diff2html](#diff2html)
    - [recommended html render solution of `diff2html-cli` based on `npm`](#recommended-html-render-solution-of-diff2html-cli-based-on-npm)
    - [a simpler solution to have a look at basic html style (based on vim)](#a-simpler-solution-to-have-a-look-at-basic-html-style-based-on-vim)
    - [gerrit render effect](#gerrit-render-effect)
        - [under file list view](#under-file-list-view)
        - [under file content view](#under-file-content-view)
- [copy selected lines to clipboard](#copy-selected-lines-to-clipboard)
- [how to delete from current position to the end of line](#how-to-delete-from-current-position-to-the-end-of-line)
- [how to force tab to be spaces (so that the git diff won't have errors)](#how-to-force-tab-to-be-spaces-so-that-the-git-diff-wont-have-errors)
- [how to filter matched lines](#how-to-filter-matched-lines)
    - [resolution 1. just to display (no buffer)](#resolution-1-just-to-display-no-buffer)
    - [resolution 2. write into current files](#resolution-2-write-into-current-files)
    - [BEST-PRACTICE: resolution 3. open a new vim window](#best-practice-resolution-3-open-a-new-vim-window)
- [how to resize height and width](#how-to-resize-height-and-width)
    - [resolution 1. use commands](#resolution-1-use-commands)
    - [resolution 2. use mouse](#resolution-2-use-mouse)
- [how to highlight line or column](#how-to-highlight-line-or-column)
- [mouse mode](#mouse-mode)
- [vimdiff](#vimdiff)
    - [:white\_check\_mark: force `vimdiff` to wrap line](#white_check_mark-force-vimdiff-to-wrap-line)
    - [TODO: vimdiff show only differences](#todo-vimdiff-show-only-differences)
- [bookmarks](#bookmarks)
- [files relative](#files-relative)
    - [open other file](#open-other-file)
    - [copy between two vim files](#copy-between-two-vim-files)
- [how to update `vim`](#how-to-update-vim)
- [multi-line insert under `visual mode`](#multi-line-insert-under-visual-mode)
- [Copy-Paste in Vim](#copy-paste-in-vim)
    - [copy paste of line](#copy-paste-of-line)
    - [copy paste of selected](#copy-paste-of-selected)
    - [how to copy to clipboard](#how-to-copy-to-clipboard)
- [how to insert datetime](#how-to-insert-datetime)
- [column selection](#column-selection)
- [undo changes after file saved](#undo-changes-after-file-saved)
- [search for selected text](#search-for-selected-text)
- [fold(collapse) and unfold(expand)](#foldcollapse-and-unfoldexpand)
- [Plugin Manager](#plugin-manager)
    - [comparison](#comparison)
    - [`vim-plug`](#vim-plug)
    - [install `YouCompleteMe` via `vim-plug`](#install-youcompleteme-via-vim-plug)
    - [`vundle`: how to uninstall vim plugin](#vundle-how-to-uninstall-vim-plugin)
- [bugfix: `YouCompleteMe unavailable: requires Vim 8.1.2269+.`](#bugfix-youcompleteme-unavailable-requires-vim-812269)
    - [scenario](#scenario)
    - [resolution 1: using an older version of `youcompleteme`](#resolution-1-using-an-older-version-of-youcompleteme)
    - [resolution 2: using the latest vim built from source](#resolution-2-using-the-latest-vim-built-from-source)
