...
> **导读**：今年（2025年）3月，Anthropic 发布了一项关于大模型可解释性的突破性研究，为我们提供了一种前所未有的“AI显微镜”，得以一窥 Claude 内部复杂的“思维”过程。时隔数月，这项工作的重要性愈发凸显，它不仅揭示了模型内部惊人的运作机制，也为我们理解和构建更安全、更可靠的 AI 系统指明了方向。
>
> 本文将对 Anthropic 的两篇核心论文进行深度编译，忠实呈现其关键发现，并为你标记出最值得深思的环节。我们将一同探索：Claude 是如何实现跨语言思考的？它在写诗时真的会“未雨绸缪”吗？以及，它在解释自己推理过程时，是否有时只是在为早已确定的结论“伪造”一个看似合理的论证？
...
以下，我们将跟随 Anthropic 的视角，深入探索其研究中最引人注目的几项“AI 生物学”发现。
